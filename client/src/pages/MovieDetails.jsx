...
const MovieDetails = () => {
  ...
  const { axios, getToken, user, image_base_url, shows, fetchFavoriteMovies, favoriteMovies } = useAppContext();
      ...
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className=' relative flex flex-col gap-3'>
          ...
          <div className='flex items-center gap-2 text-gray-300'>
            ...
            { show.movie.vote_average.toFixed(1)} Viewer Rating
          </div>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            ...
            <a href='#dateSelect' className='px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer active:scale-90' >Buy Tickets</a>
            <button className='bg-gray-700 p-2.5 rounded-full transition cursor-pointer active:scale-90'>
